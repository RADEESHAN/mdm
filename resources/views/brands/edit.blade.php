            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('brands.update', $brand) }}">
                        ...
                        <!-- Code -->
                        <div class="mb-4">
                            <label for="code" class="block text-sm font-medium text-gray-700">Brand Code</label>
                            <input type="text" name="code" id="code" value="{{ old('code', $brand->code) }}" required
                        ...
                        <div class="flex items-center justify-between mt-6">
                            <a href="{{ route('brands.index') }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400">
                                Cancel
                            </a>
